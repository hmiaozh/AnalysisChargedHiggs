...
//	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/LDOJun.root");
//	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/June_la/June_la.root");
...
//		mass_mirror.push_back(  (TH1D*)mirror[i]->Get("invariant_ChargedHiggs_HplusTB_HplusToTB_M-800_13TeV_amcatnlo_pythia8") );
		mass_signal.push_back(  (TH1D*)signal[i]->Get("W_pt_nopu_QCD_HT") );
                mass_mirror.push_back(  (TH1D*)signal[i]->Get("W_pt_pu_QCD_HT") );
	}
...
//                mass_mirror[i]->Rebin(2);
		...
		mass_mirror[i]->GetXaxis()->SetRangeUser(200,1200);
		mass_mirror[i]->GetXaxis()->SetTitle("P_{T W}");
		mass_mirror[i]->GetYaxis()->SetTitle("Normalized Entries");
		...
		latex.SetNDC();
        	...
        	TLegend *legend1 = new TLegend(0.6,0.75,0.75,0.89);
		legend1->SetTextFont(42);
		legend1->SetTextSize(0.05);
        	legend1->AddEntry(mass_signal[i],"NVertices < 20","l");
        	legend1->AddEntry(mass_mirror[i],"NVertices #geq 20","l");
        	legend1->Draw("same");

		char xname[500];

                sprintf(xname,"/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXOup/PileUp_W_category_%i.png",i); 
