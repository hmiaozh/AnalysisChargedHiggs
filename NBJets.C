...
const int prosepatype = 1;    //6--discr;13--sepa type
const int colorbkg[bkgtype] = {kBlue-10,kGreen-10,kGreen-10,kGreen-10,kAzure-9,kGray,kGray,kGray,kGray,kGray,kOrange-9};
TString bkgname[bkgtype] = {"TT_TuneCUETP8M2T4_13TeV-powheg-pythia8","WJets","ZJets","DYJets","ST","TTW","TTZ","TTG","TTTT","ttH","QCD_HT"};
...
TString prosepaname[prosepatype] = {"NBjets"};
...
//	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/ntufile/ending17.root");
	...
	tb[0] = (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/Baseline");
	...
	tbs[0] = (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/Baseline");
...
//		ths_all->GetXaxis()->SetTitle(prosepaname[i]);		
		...
		ths_all->GetXaxis()->SetTitle("#b jets");
