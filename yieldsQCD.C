...
TString bkgshort[bkgtype] = {"HT500-700","HT700-1000","HT700-1000","HT700-1000","HT1000-1500","HT1500-2000","HT1500-2000","HT1500-2000","HT1500-2000","HT1500-2000","HT2000-inf"};
...
//	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/ntufile/Mirror0b.root");
	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/ntufile/QCDspike.root");	
...
*/
	...
	sprintf(mass_b[0],"invariantExt_QCD_HT500to700");
	sprintf(mass_b[1],"invariantExt_QCD_HT700to1000");
	sprintf(mass_b[2],"invariantExt_DYJets");
	sprintf(mass_b[3],"invariantExt_ZJets");
	sprintf(mass_b[4],"invariantExt_QCD_HT1000to1500");
	sprintf(mass_b[5],"invariantExt_QCD_HT1500to2000");
	...
	sprintf(mass_b[10],"invariantExt_QCD_HT2000toInf");
	
	
	TH1D* ycb[11];
	for(int m=0; m<11; m++){
		ycb[m] = new TH1D(mass_b[m],mass_b[m],18,0,18);
	}
	...
	for(Int_t i=0; i<18; i++) {
		...
		if(m1000tass != NULL) sig1000t = m1000tass->Integral(m1000low,m1000up);
		if(m1000w != NULL) sig1000w = m1000w->Integral(m1000low,m1000up);
		signall->SetBinContent(i+1,sig1000t);
                signalw->SetBinContent(i+1,sig1000w);
		for(int j=0; j<11; j++){
			double bkgnum = 0;
			ht[j] = (TH1D*)categ[i]->Get(mass_b[j]);
			if(ht[j] != NULL) bkgnum = ht[j]->Integral(m1000low,m1000up);
...
//        legend0->Draw("same");
	...
	legend1->Draw("same");
        ...
        c1a->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/2018Mar/mar20_yields_sr_in_gainstat.png");
