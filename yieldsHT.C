...
//	categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_one_lowj_t1b") );
//	categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_one_lowj_wbb") );
...
//        categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_one_highj_t1b") );
//	categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_one_highj_wbb") );
...
*/
	char mass_b[11][100];
	char mass_s[2][100];
	sprintf(mass_s[0],"HT_650_in_ChargedHiggs_HplusTB_HplusToTB_M-650_13TeV_amcatnlo_pythia8");
	sprintf(mass_s[1],"HT_650_in_WprimeToTB_TToHad_M-1000");
	sprintf(mass_b[0],"HT_650_in_TT_TuneCUETP8M2T4_13TeV-powheg-pythia8");
	sprintf(mass_b[1],"HT_650_in_WJets");
	sprintf(mass_b[2],"HT_650_in_DYJets");
	sprintf(mass_b[3],"HT_650_in_ZJets");
	sprintf(mass_b[4],"HT_650_in_ST");
	sprintf(mass_b[5],"HT_650_in_TTW");
	sprintf(mass_b[6],"HT_650_in_TTZ");
	sprintf(mass_b[7],"HT_650_in_TTG");
	sprintf(mass_b[8],"HT_650_in_TTTT");
	sprintf(mass_b[9],"HT_650_in_ttH");
	sprintf(mass_b[10],"HT_650_in_QCD_HT");
	
	
	TH1D* ycb[11];
	for(int m=0; m<11; m++){
		ycb[m] = new TH1D(mass_b[m],mass_b[m],16,0,16);
	}
	TH1D* signall = new TH1D("signall","",16,0,16);
        TH1D* signalw = new TH1D("signalw","",16,0,16);	
...
//	TCanvas *c1a = new TCanvas("c1a","c1a",2000,800);
	TCanvas *c1a = new TCanvas("c1a","c1a",1600,800);
        c1a->cd(1);
	c1a->SetLogy();
	c1a->SetGridy();
        c1a->SetGridx();
...
*/
	...
	cateyields->GetXaxis()->SetBinLabel(5,"#geq2b_t0b");
        cateyields->GetXaxis()->SetBinLabel(6,"#geq2b_t1b");
        cateyields->GetXaxis()->SetBinLabel(7,"#geq2b_wbb");
        cateyields->GetXaxis()->SetBinLabel(8,"#geq2b_wbj");
	cateyields->GetXaxis()->SetBinLabel(9,"1b_t0b");
        cateyields->GetXaxis()->SetBinLabel(10,"1b_t1b");
        cateyields->GetXaxis()->SetBinLabel(11,"1b_wbb");
        cateyields->GetXaxis()->SetBinLabel(12,"1b_wbj");
        cateyields->GetXaxis()->SetBinLabel(13,"#geq2b_t0b");
        cateyields->GetXaxis()->SetBinLabel(14,"#geq2b_t1b");
        cateyields->GetXaxis()->SetBinLabel(15,"#geq2b_wbb");
        cateyields->GetXaxis()->SetBinLabel(16,"#geq2b_wbj");
...
//        c1a->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/2018Mar/mar25(24file)_sr_in_yields_3c.png");
