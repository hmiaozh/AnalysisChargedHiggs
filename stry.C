...
*/
	categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_t0b") );
        categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_t1b") );
	categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_wbb") );
        categ.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_wbj") );
...
*/
	...
	char mass[5][100];
	sprintf(mass[0],"invariantExt_WprimeToTB_TToHad_M-800");
	sprintf(mass[1],"invariantExt_WprimeToTB_TToHad_M-1000");
	sprintf(mass[2],"invariantExt_WprimeToTB_TToHad_M-1500");
	sprintf(mass[3],"invariantExt_WprimeToTB_TToHad_M-2000");
	sprintf(mass[4],"invariantExt_WprimeToTB_TToHad_M-3000");
...
*/
	...
	for(Int_t i=0; i<4; i++) {
		...
		m800.push_back( (TH1D*)categ[i]->Get(mass[0]) );
		m1000.push_back( (TH1D*)categ[i]->Get(mass[1]) );
		m1500.push_back( (TH1D*)categ[i]->Get(mass[2]) );
		m2000.push_back( (TH1D*)categ[i]->Get(mass[3]) );
		m3000.push_back( (TH1D*)categ[i]->Get(mass[4]) );
		/*
...
*/
	...
	//	cat[i]->SetPoint(1,500,30*(m500up-m500low));
		cat[i]->SetPoint(0,800,bnum*10*(m800up-m800low));
		cat[i]->SetPoint(1,1000,bnum*10*(m1000up-m1000low));
		cat[i]->SetPoint(2,1500,bnum*10*(m1500up-m1500low));
		cat[i]->SetPoint(3,2000,bnum*10*(m2000up-m2000low));
		cat[i]->SetPoint(4,3000,bnum*10*(m3000up-m3000low));
