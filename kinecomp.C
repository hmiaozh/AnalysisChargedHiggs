...
const int prosepatype = 15;    //6--discr;13--sepa type
...
TString prosepaname[prosepatype] = {"ST","HT","invariantExt","NBjets","Njets","NFatjets","top_pt","W_pt","TAU32","TAU21","PtTopH","PtB1","softdropM","nbsubjet","nbsubjetloose"};
...
void kinecomp(){
	...
	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/ntufile/ending17tot.root");
...
//		hRatio->GetYaxis()->SetNdivisions(502);
		...
		c1->SaveAs(Form("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/DecAN/dec15_QCD_mirror_%s.png",proname[i].Data()));
	}
...
//              hRatio->GetYaxis()->SetNdivisions(502);
		hRatio->Draw("P E X0 SAME");
                ...
                c1->SaveAs(Form("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/DecAN/dec15_QCD_mirror_%s_cate%i.png",prosepaname[i].Data(),k));
        }
     }
