...
//	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/SoHot.root");
	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/ntufile/pipilimitnew.root");

	TDirectoryFile* t0b_combined = (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_one_highj_t0b");
...
//        TDirectoryFile* wbj_combined = (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_wbj");
	...
	mass_in_1000->Rebin(2);
	mass_in_qcd->Rebin(2);
	mass_in_ttbar->Rebin(2);

	mass_below_1000->Rebin(2);
	mass_below_qcd->Rebin(2);
	mass_below_ttbar->Rebin(2);

	mass_above_1000->Rebin(2);
	mass_above_qcd->Rebin(2);
	mass_above_ttbar->Rebin(2);
...
*/
	...
	mass_in_1000->SetLineColor(kRed-7);
	mass_in_1000->SetLineWidth(2);
//	mass_in_1000->SetFillColor(kRed-10);
	mass_in_1000->SetFillColorAlpha(kRed-10,0.25);
//	mass_in_1000->Scale(1000*lumin);
	mass_in_ttbar->SetLineColor(kRed-7);
	mass_in_ttbar->SetLineWidth(2);
	mass_in_ttbar->SetFillColorAlpha(kRed-10,0.25);
//        mass_in_ttbar->Scale(1000*lumin);
	mass_in_qcd->SetLineColor(kRed-7);
	mass_in_qcd->SetLineWidth(2);
	mass_in_qcd->SetFillColorAlpha(kRed-10,0.25);
//	mass_in_qcd->Scale(1000*lumin);

	mass_below_1000->SetLineColor(kBlue-7);
	mass_below_1000->SetLineWidth(2);
	mass_below_1000->SetFillColorAlpha(kBlue-10,0.25);
//        mass_below_1000->Scale(1000*lumin);
        mass_below_ttbar->SetLineColor(kBlue-7);
	mass_below_ttbar->SetLineWidth(2);
	mass_below_ttbar->SetFillColorAlpha(kBlue-10,0.25);
//        mass_below_ttbar->Scale(1000*lumin);
        mass_below_qcd->SetLineColor(kBlue-7);
	 mass_below_qcd->SetLineWidth(2);
	mass_below_qcd->SetFillColorAlpha(kBlue-10,0.25);
//        mass_below_qcd->Scale(1000*lumin);

	mass_above_1000->SetLineColor(kGreen-7);
	mass_above_1000->SetLineWidth(2);
	mass_above_1000->SetFillColorAlpha(kGreen-10,0.25);
//        mass_above_1000->Scale(1000*lumin);
        mass_above_ttbar->SetLineColor(kGreen-7);
	mass_above_ttbar->SetLineWidth(2);
	mass_above_ttbar->SetFillColorAlpha(kGreen-10,0.25);
//        mass_above_ttbar->Scale(1000*lumin);
        mass_above_qcd->SetLineColor(kGreen-7);
	mass_above_qcd->SetLineWidth(2);
	mass_above_qcd->SetFillColorAlpha(kGreen-10,0.25);
//        mass_above_qcd->Scale(1000*lumin);
...
//	gStyle->SetOptStat(1111);
        ...
        c1a->cd(1);
        mass_in_1000->Draw("hist");
	mass_below_1000->Draw("hist sames");
	mass_above_1000->Draw("hist sames");
        mass_in_1000->GetXaxis()->SetRangeUser(800.,3000.0);
	mass_in_1000->GetXaxis()->SetTitle("HT[GeV]");
//	mass_in_1000->GetYaxis()->SetRangeUser(1.,16000.0);
	mass_in_1000->GetYaxis()->SetTitle("Events");
	...
	legend4a->AddEntry(mass_in_1000,"in","f");
        legend4a->AddEntry(mass_below_1000,"below","f");
	legend4a->AddEntry(mass_above_1000,"above","f");
        legend4a->Draw("same");

//        c1a->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXOup/HTinmasswindow_1000.png");


	TCanvas *c1b = new TCanvas("c1b","c1b",800,600);
        c1b->cd(1);
        mass_below_ttbar->Draw("hist");
        mass_in_ttbar->Draw("hist sames");
        mass_above_ttbar->Draw("hist sames");
        mass_below_ttbar->GetXaxis()->SetRangeUser(800.,3000.0);
        mass_below_ttbar->GetXaxis()->SetTitle("HT[GeV]");
	mass_below_ttbar->GetYaxis()->SetTitle("Events");
	...
	TLegend *legend4b = new TLegend(0.64,0.78,0.84,0.94);
        legend4b->AddEntry(mass_in_ttbar,"in","f");
        legend4b->AddEntry(mass_below_ttbar,"below","f");
        legend4b->AddEntry(mass_above_ttbar,"above","f");
        legend4b->Draw("same");


//	c1b->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXOup/HTinmasswindow_ttbar.png");

	TCanvas *c1c = new TCanvas("c1c","c1c",800,600);
        c1c->cd(1);
        mass_below_qcd->Draw("hist");
        mass_in_qcd->Draw("hist sames");
        mass_above_qcd->Draw("hist sames");
        mass_in_qcd->GetXaxis()->SetRangeUser(800.,3000.0);
        mass_in_qcd->GetXaxis()->SetTitle("HT[GeV]");
        mass_in_qcd->GetYaxis()->SetTitle("Events");
	...
	TLegend *legend4c = new TLegend(0.64,0.78,0.84,0.94);
        legend4c->AddEntry(mass_in_qcd,"in","f");
        legend4c->AddEntry(mass_below_qcd,"below","f");
        legend4c->AddEntry(mass_above_qcd,"above","f");
        legend4c->Draw("same");


  //      c1c->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXOup/HTinmasswindow_qcd.png");
...
///////
	...
	invariant_t1b->GetXaxis()->SetTitle("Mass_(t+b)[GeV]");
//	invariant_t1b->GetYaxis()->SetRangeUser(1.,5000.0);
	invariant_t1b->GetYaxis()->SetTitle("Event");
...
/////////
	...
	invariant_tb->GetXaxis()->SetTitle("Mass_(t+b)[GeV]");
//        invariant_tb->GetYaxis()->SetRangeUser(1.,16000.0);
	invariant_tb->GetYaxis()->SetTitle("Event");

        TLegend *legend4 = new TLegend(0.64,0.78,0.84,0.94);
	...
	invariant_wbb->GetXaxis()->SetTitle("Mass_(W+b+b)[GeV]");
	invariant_wbb->GetYaxis()->SetTitle("Event");

	TLegend *legend2 = new TLegend(0.64,0.78,0.84,0.94);
...
////////
	...
	invariant_wbj->GetXaxis()->SetTitle("Mass_(W+b+j)[GeV]");
        invariant_wbj->GetYaxis()->SetTitle("Event");
	
        TLegend *legend3 = new TLegend(0.64,0.72,0.84,0.88);
