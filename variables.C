...
void variables(){
	...
	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/insaneM/insaneM.root");
...
//	gStyle->SetOptStat(1111);
	...
	invariant_t0b->GetXaxis()->SetTitle("Mass_(t+b)[GeV]");
	...
	legend4a->AddEntry(mass_t0b_qcd,"QCD,t(0)+b","f");
        ...
        c1a->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXO/invariant_t0b.png");
///////
...
//	invariant_t1b->GetYaxis()->SetRangeUser(1.,5000.0);
	invariant_t1b->GetYaxis()->SetTitle("Event");
        ...
        c1b->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXO/invariant_t1b.png");
/////////
	TCanvas *c1 = new TCanvas("c1","c1",800,600);
        c1->cd(1);
...
//        invariant_tb->GetYaxis()->SetRangeUser(1.,16000.0);
	invariant_tb->GetYaxis()->SetTitle("Event");
        ...
        c1->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXO/invariant_tb.png");
	...
	TLegend *legend2 = new TLegend(0.64,0.78,0.84,0.94);
        ...
        c2->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXO/invariant_wbb.png");
////////
	...
	invariant_wbj->GetXaxis()->SetTitle("Mass_(W+b+j)[GeV]");
        ...
        c3->SaveAs("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/EXO/invariant_wbj.png");
