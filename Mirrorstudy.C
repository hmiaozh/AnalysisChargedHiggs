...
//	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/ttbarSR/ttbarSR.root");
	TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/SoHot.root");
//	TFile* f2 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/ttbarCR/ttbarCR.root");
...
/*	
	...
	mirror.push_back( (TDirectoryFile*)f2->Get("ChargedHiggsTopBottom/OneBOneFat_t0b") );
        mirror.push_back( (TDirectoryFile*)f2->Get("ChargedHiggsTopBottom/OneBOneFat_t1b") );
        mirror.push_back( (TDirectoryFile*)f2->Get("ChargedHiggsTopBottom/OneBOneFat_wbb") );
        mirror.push_back( (TDirectoryFile*)f2->Get("ChargedHiggsTopBottom/OneBOneFat_wbj") );
*/

	signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_one_t0b") );
	signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_one_wbj") );

	signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_two_t0b") );
        signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_two_t1b") );
	signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_two_wbb") );
	signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_two_wbj") );

	signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_three_t0b") );
        signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_three_t1b") );
        signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_three_wbb") );
        signal.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneFat_three_wbj") );


	mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_one_t0b") );
        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_one_wbj") );

        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_two_t0b") );
        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_two_t1b") );
        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_two_wbb") );
        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_two_wbj") );

        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_three_t0b") );
        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_three_t1b") );
        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_three_wbb") );
        mirror.push_back( (TDirectoryFile*)f1->Get("ChargedHiggsTopBottom/OneBOneMirrorFat_three_wbj") );


	for(int i=0; i<10; i++){
		char haname[100];
//		mass_signal.push_back(	(TH1D*)signal[i]->Get("invariant_ChargedHiggs_HplusTB_HplusToTB_M-800_13TeV_amcatnlo_pythia8") );
//		mass_mirror.push_back(  (TH1D*)mirror[i]->Get("invariant_ChargedHiggs_HplusTB_HplusToTB_M-800_13TeV_amcatnlo_pythia8") );
		mass_signal.push_back(  (TH1D*)signal[i]->Get("invariantExt_QCD_HT") );
                mass_mirror.push_back(  (TH1D*)mirror[i]->Get("invariantExt_QCD_HT") );
//		mass_signal.push_back(  (TH1D*)signal[i]->Get("HT_TT_TuneCUETP8M2T4_13TeV-powheg-pythia8") );
//		mass_mirror.push_back(  (TH1D*)mirror[i]->Get("ST_TT_TuneCUETP8M2T4_13TeV-powheg-pythia8") );
//		if(i<2) sprintf(haname,"invariantExt_TT_TuneCUETP8M2T4_13TeV-powheg-pythia8");
//		else sprintf(haname,"invariantExt_TT_TuneCUETP8M2T4_13TeV-powheg-pythia8");
...
//		mass_mirror.push_back(  (TH1D*)mirror[i]->Get(haname) );
	...
	for(int i=0; i<10; i++){
		...
		mass_signal[i]->Rebin(2);
                mass_mirror[i]->Rebin(2);
		...
		mass_mirror[i]->GetXaxis()->SetRangeUser(750,3000);
		char cname[50];
	...
	//	mass_signal[i]->Draw("hist");
		mass_mirror[i]->Draw("hist");
        	mass_signal[i]->Draw("hist same");
		mass_mirror[i]->GetXaxis()->SetTitle("M_{t+b}[GeV]");
		mass_mirror[i]->GetYaxis()->SetTitle("Events");
        	//mass_mirror[i]->Draw("hist same");
		mass_mirror[i]->GetYaxis()->SetTitleOffset(1.35);
		...
		legend1->SetTextSize(0.05);
        	legend1->AddEntry(mass_signal[i],"Signal","l");
        	legend1->AddEntry(mass_mirror[i],"CRI:Mirror","l");
        	legend1->Draw("same");


		char xname[500];

                sprintf(xname,"/afs/cern.ch/work/h/hum/public/CMSSW_8_0_26_patch1/src/ChargedHiggs/Analysis/Plots/newstage/trigger/workshop_mirror_HT_category_%i.png",i); 
